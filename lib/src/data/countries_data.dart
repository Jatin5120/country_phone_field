...
class Country {
  ...
  static const CountryModel saintHelenaAscensionAndTristanDaCunha =
      CountryModel(
    name: CountryKeys.saintHelenaAscensionAndTristanDaCunha,
    flag: '🇸🇭',
    flagSvg: '$_basePath/sh.svg',
    countryCode: 290,
    isoCode: 'SH',
    maxLength: 4,
    continent: Continent.africa,
  ...
  static const CountryModel southGeorgiaAndTheSouthSandwichIslands =
      CountryModel(
    name: CountryKeys.southGeorgiaAndTheSouthSandwichIslands,
    flag: '🇬🇸',
    flagSvg: '$_basePath/gs.svg',
    countryCode: 500,
    isoCode: 'GS',
    maxLength: 15,
    continent: Continent.antarctica,
